use super::vec3::{Vec3, vec3_sub, vec3_tri_add, vec3_mul, vec3_product, 
	generate_unit_vector, random_in_unit_disk, vec3_add};
...
impl CameraCharacteristics {
	pub fn new(vfov: f64, aspect_ratio: f64, aperture: f64, focus_dist: f64) -> Self {
		Self { vfov, aspect_ratio, aperture, focus_dist }
	}
}
...
impl Camera {
	pub fn new(
		...
		Camera {
			...
			time0: time01.time0, time1: time01.time1,
		}
	}
