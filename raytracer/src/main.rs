...
// extern crate rayon;
// use rayon::prelude::*;
use crate::object::material::{Lambertian, Material, Materials, Metal};
...
fn get_colour(r: &Ray, world: &HittableList, depth: &i32) -> Vec3 {
    ...
    let mut rec = HitRecord::new(&Materials::MetalMaterials(Metal::set(0.0, 0.0, 0.0)));
...
fn main() {
    let path = "output/book1/image1-11.jpg";
    // let width: u32 = 800;
    ...
    let mat_center = Materials::LambertianMaterials(Lambertian::set(0.7, 0.3, 0.3));
    let mat_left = Materials::MetalMaterials(Metal::set(0.8, 0.8, 0.8));
    let mat_right = Materials::MetalMaterials(Metal::set(0.8, 0.6, 0.2));
