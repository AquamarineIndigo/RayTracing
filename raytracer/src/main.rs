pub mod basic;
pub mod object;
use basic::vec3::{Vec3, vec3_add, /*vec3_dot,*/ vec3_mul, /*vec3_sub,vec3_tri_add, random_unit_vector,*/  generate_unit_vector};
use basic::ray::Ray;
...
use crate::object::material::{Material, Lambertian, Metal, Materials};

use crate::basic::camera::{Camera, write_colour};
...
fn main() {
	...
	let mat_right = Materials::MetalMaterials(Metal::set(0.8, 0.6, 0.2, 1.0));
